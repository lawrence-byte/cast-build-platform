  ...
  const groups = [
    {
      ...
      items: [
        ...
        ['Critical Items', '/projects/alum-open-items.html', 'i-list'],
        ['Management Center', '/projects/alum-management-control-center.html', 'i-cog'],
      ],
    },
    {
      label: 'Documents',
      summary: 'Document controls, logs, minutes, RFIs, submittals',
      items: [
        ['Document Dashboard', '/projects/golden-hill-documents.html', 'i-document'],
        ['RFI Tracking', '/projects/alum-rfis.html', 'i-help'],
        ['RFI Workflow Spec', '/projects/cast-rfi-tracker.html', 'i-help'],
        ['Submittal Tracking', '/projects/alum-submittals.html', 'i-clipboard'],
        ['Submittal Workflow Spec', '/projects/cast-submittal-tracker.html', 'i-clipboard'],
