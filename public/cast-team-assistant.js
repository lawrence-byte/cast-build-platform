...
(function () {
  ...
  function css() {
    ...
    style.textContent = `
      ...
      .cast-team-assistant-host--centered{top:88px;left:calc(272px + ((100vw - 272px) / 2));right:auto;transform:translateX(-50%)}
      .cast-team-assistant-host--nav{position:relative;top:auto;left:auto;right:auto;bottom:auto;transform:none;z-index:1;margin:0;width:max-content}
      ...
      .cast-team-assistant-host--landing .cast-team-assistant-trigger{width:76px;height:76px;padding:11px}.cast-team-assistant-host--centered .cast-team-assistant-trigger{width:105px;height:105px;padding:15px}.cast-team-assistant-host--nav .cast-team-assistant-trigger{width:56px;height:56px;padding:8px}.cast-team-assistant-trigger img{width:100%;height:100%;object-fit:contain;display:block}.cast-team-assistant-trigger:hover{background:#2a2925;transform:translateY(-1px)}.cast-team-assistant-label{display:none}
      ...
      .cast-team-assistant-host--centered .cast-team-assistant-panel,.cast-team-assistant-host--nav .cast-team-assistant-panel{left:50%;right:auto;transform:translateX(-50%)}
      ...
      @media(max-width:1050px){.cast-team-assistant-host--centered{top:82px;left:50%;right:auto;transform:translateX(-50%)}}
      @media(max-width:700px){.cast-team-assistant-host{top:14px;right:14px;bottom:auto;margin:0}.cast-team-assistant-host--landing{position:relative;top:auto;left:auto;right:auto;transform:none;margin:0 auto}.cast-team-assistant-host--centered{top:78px;left:50%;right:auto;transform:translateX(-50%)}.cast-team-assistant-trigger{width:62px;height:62px}.cast-team-assistant-host--landing .cast-team-assistant-trigger{width:68px;height:68px;padding:10px}.cast-team-assistant-host--centered .cast-team-assistant-trigger{width:93px;height:93px;padding:13px}.cast-team-assistant-host--nav .cast-team-assistant-trigger{width:48px;height:48px;padding:7px}.cast-team-assistant-panel{left:12px;right:12px;top:118px;bottom:auto;width:auto;transform:none}.cast-team-assistant-host--centered .cast-team-assistant-panel,.cast-team-assistant-host--nav .cast-team-assistant-panel{left:12px;right:12px;transform:none}.cast-team-assistant-label{display:none}}
    `;
  ...
  function mount() {
    ...
    const navTarget = !isLanding ? document.querySelector('.alum-project-nav__assistant-slot') : null;
    const host = document.createElement('div');
    host.id = 'castTeamAssistantHost';
    host.className = `cast-team-assistant-host ${isLanding ? 'cast-team-assistant-host--landing' : navTarget ? 'cast-team-assistant-host--nav' : 'cast-team-assistant-host--centered'}`;
    host.innerHTML = `
    ...
    else if (navTarget) navTarget.appendChild(host);
