...
(function () {
  ...
  function css() {
    ...
    style.textContent = `
      ...
      .cast-team-assistant-host--landing .cast-team-assistant-trigger{width:76px;height:76px;padding:11px}.cast-team-assistant-host--centered .cast-team-assistant-trigger{width:105px;height:105px;padding:15px}.cast-team-assistant-trigger img{width:100%;height:100%;object-fit:contain;display:block}.cast-team-assistant-trigger:hover{background:#2a2925;transform:translateY(-1px)}.cast-team-assistant-label{display:none}
      ...
      .cast-team-assistant-host--centered .cast-team-assistant-panel{left:50%;right:auto;transform:translateX(-50%)}
