...
(function () {
  ...
  function css() {
    ...
    style.textContent = `
      ...
      .cast-team-assistant-host--centered{top:14px;left:50%;right:auto;transform:translateX(-50%)}
